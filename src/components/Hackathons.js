    ...
    return (
        <div className="hackathons-wrapper">
            ...
            <div className="hackathons-cards">
                ...
                <Card style={{ width: 400, marginLeft: 50, marginRight: 50,marginTop: 25 }} cover={<img alt="example" src={hack1}/>}>
                ...
                <Card style={{ width: 400, marginLeft: 50, marginRight: 50,marginTop: 25 }} cover={<img alt="example" src={hack2}/>}>
                ...
                <Card style={{ width: 400, marginLeft: 50, marginRight: 50,marginTop: 25 }} cover={<img alt="example" src={hack3}/>}>
